...
#define VECTOR_TABLE_ADDRESS					((uint32_t*)ADDR_FLASH_SECTOR_3)
#define VECTOR_TABLE_SIZE						((uint32_t)(ADDR_FLASH_SECTOR_4 - ADDR_FLASH_SECTOR_3))
#define EEPROM_EMULATION_SIZE					((uint32_t)(ADDR_FLASH_SECTOR_3 - ADDR_FLASH_SECTOR_1))

#define APP_START_ADDRESS						((uint32_t*)(ADDR_FLASH_SECTOR_4))
