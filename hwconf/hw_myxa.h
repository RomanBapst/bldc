...
#define LED_RED_ON()			palClearPad(GPIOC, 8)
#define LED_RED_OFF()			palSetPad(GPIOC, 8)

#define SKIP_FLASH_CORRUPTION_CHECK
...
#define NTC_TEMP(adc_ind)		40.0f//(1.0 / ((logf(NTC_RES(ADC_Value[adc_ind]) / 10000.0) / 3434.0) + (1.0 / 298.15)) - 273.15)

#define NTC_RES_MOTOR(adc_val)	(10000.0 / ((4095.0 / (float)adc_val) - 1.0)) // Motor temp sensor on low side
#define NTC_TEMP_MOTOR(beta)	40.0f//(1.0 / ((logf(NTC_RES_MOTOR(ADC_Value[ADC_IND_TEMP_MOTOR]) / 10000.0) / beta) + (1.0 / 298.15)) - 273.15)
